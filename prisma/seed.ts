...
<p>Profitez pleinement des beaux jours avec cette piscine tubulaire ronde, idéale pour se rafraîchir en famille durant tout l'été. Grâce à sa structure métallique renforcée et sa toile PVC triple épaisseur, elle offre une excellente résistance et une grande stabilité.

Facile à installer et à démonter, cette piscine est parfaite pour transformer rapidement votre jardin en véritable espace de détente.

Caractéristiques principales
Forme : Ronde
Couleur extérieure : Gris anthracite
Couleur intérieure : Bleu mosaïque
Structure : Tubes en acier galvanisé anticorrosion
Revêtement : PVC triple épaisseur haute résistance
Installation rapide sans travaux
Compatible avec système de filtration
Dimensions
Diamètre : 366 cm
Hauteur : 100 cm
Surface au sol : 10,5 m²
Capacité d'eau : 9 150 litres
Poids du colis : 42 kg
Les points forts

✓ Structure métallique robuste

✓ Toile renforcée résistante aux UV

✓ Montage simple en moins de 60 minutes

✓ Grande capacité pour toute la famille

✓ Excellente stabilité

✓ Entretien facile

✓ Idéale pour les jardins et terrasses spacieuses

Contenu du colis
1 Piscine tubulaire ronde
Structure complète en acier
Kit de raccordement
Notice de montage détaillée</p>
<h4>Points forts :</h4>
<ul>
...
<li>Installation facile sans outil</li>
      ...
      images: [
        {
          url: "https://i.ibb.co/WNjdyk4K/8057-011726583-3.jpg",
          isPrimary: true,
        },
      ],
      attributes: [
...
<p>Avec un diamètre de 3,66 m pour 91 cm de hauteur, elle offre un espace de jeux parfait tout l'été.</p>`,
      ...
      images: [
        {
          url: "https://i.ibb.co/JFpHX9sS/28132np-kit-piscine-gonflable-easy-set.jpg",
          isPrimary: true,
        },
      ],
      attributes: [
    ...
    {
      name: "Spa gonflable Intex Blue One 2-4 places",
      slug: "spa-gonflable-intex-blue-one-2-4-places",
      sku: "INT-SPA-BLUE1",
      shortDescription: "Piscine gonflable ronde idéale pour les petits jardins",
      description: `<h3>Simple, rapide et efficace</h3>
<p>Avec son design à la fois sobre et moderne, ce spa gonflable s'intègrera facilement à votre extérieur.</p>
<p>Produit parfait pour vous détendre après une journée de travail bien remplie, le PureSpa Blue One peut accueillir jusqu'à 4 personnes.
Partagez un moment convivial en famille ou entre amis dans votre nouveau havre de paix.</p>`,
      price: 299.99,
      ...
      images: [
  {
    url: "https://i.ibb.co/fVQpRh4g/28486ex-spa-gonflable-blue-one-2-4-places-1.jpg",
    isPrimary: true,
  },
  {
    url: "https://i.ibb.co/fdQbY5W0/28486ex-spa-gonflable-blue-one-2-4-places.png",
    isPrimary: false,
  },
  {
    url: "https://i.ibb.co/M5WbwV76/28486ex-spa-gonflable-blue-one-2-4-places-2.jpg",
    isPrimary: false,
  },
],
      attributes: [
...
<p>Apportez une touche d'élégance et de modernité à votre extérieur avec cet ensemble de jardin haut de gamme composé d'une table rectangulaire et de chaises assorties. Son design contemporain noir mat s'intègre parfaitement sur une terrasse, un balcon spacieux ou dans un jardin.

Fabriqué avec une structure robuste en aluminium thermolaqué, cet ensemble est conçu pour résister aux intempéries et à une utilisation quotidienne en extérieur.

Disponible à l'achat en plusieurs configurations :

Table seule
Chaise seule
Ensemble complet : 1 table + 6 chaises
Caractéristiques de la table
Couleur : Noir anthracite mat
Matériau : Aluminium thermolaqué
Forme : Rectangulaire
Longueur : 180 cm
Largeur : 90 cm
Hauteur : 75 cm
Poids : 22 kg
Entretien facile
Résistante aux UV et à la corrosion
Caractéristiques des chaises
Couleur : Noir anthracite
Structure : Aluminium thermolaqué
Revêtement : Cordage synthétique tressé haute résistance
Coussin d'assise inclus
Largeur : 58 cm
Profondeur : 60 cm
Hauteur : 82 cm
Hauteur d'assise : 46 cm
Poids : 5,5 kg par chaise</p>
<p>Ensemble de Jardin Design Noir – Table + Chaises</p>`,
      price: 799.99,
      ...
      images: [
        {
          url: "https://i.ibb.co/5hdsCV8M/7017859c-f59c-444b-8f21-16fd1d7ff327.png",
          isPrimary: true,
        },
      ],
      attributes: [
...
<p>La toile en polyester 180 g/m² traité anti-UV bloque 95% des rayons UV.</p>`,
    ...
    // ---- BARBECUES ----
    {
      name: "Barbecue à gaz Genesis® E-415W 4 Brûleurs ",
      slug: "barbecue-gaz-weber-genesis-e415w-4-bruleurs",
      sku: "WEB-gns-415w",
      shortDescription: "Le barbecue à gaz compact et performant de Weber",
      description: `<h3>L'art du barbecue selon Weber</h3>
<p>Le Weber Genesis® E-415W est le barbecue à gaz idéal pour les terrasses et balcons. Ses 4 brûleurs en inox développent 48 000 BTU pour une cuisson homogène et précise.</p>
<p>La grille de cuisson en fonte émaillée retient la chaleur et crée les fameuses marques de grillades.</p>`,
      ...
      images: [
        {
          url: "https://i.ibb.co/RTVRXxpz/1501175-B-rgb-EMEA-1800x1800-06cf445.avif",
          isPrimary: true,
        },
      ],
      attributes: [
        { name: "Brûleurs", value: "4 brûleurs inox" },
        { name: "Puissance totale", value: "48 000 BTU" },
        { name: "Surface de cuisson", value: "5291cm2" },
        { name: "Combustible", value: "Gaz propane/butane" },
        { name: "Garantie", value: "12 ans (corps)" },
      ],
    },
    {
...
<p>Largeur de coupe 53 cm, hauteur réglable en 6 positions de 25 à 75 mm, bac collecteur 70 litres.</p>`,
      ...
      images: [
        {
          url: "https://i.ibb.co/1YmnxnHB/images.avif",
          isPrimary: true,
        },
      ],
      attributes: [
...
<p>Le Bosch Indego S+ 500 tond votre pelouse de façon autonome en lignes droites précises (technologie Logicut). Connecté via l'appli Bosch Smart Gardening, programmez-le depuis votre smartphone.</p>`,
      ...
      images: [
        {
          url: "https://i.ibb.co/QFtLPFHC/88944686-2325281887-1100x1100w-jpg.webp",
          isPrimary: true,
        },
      ],
      attributes: [
...
<p>Le Kärcher K5 Premium est le nettoyeur haute pression idéal pour les travaux de nettoyage extérieur intensifs. Avec 145 bars de pression et un débit de 500 L/h, il vient à bout des terrasses, allées et véhicules.</p>`,
      ...
      images: [
        {
          url: "https://i.ibb.co/Q7C7Xj9m/d0.jpg",
          isPrimary: true,
        },
      ],
      attributes: [
...
<p>Livré avec coussin épais 8 cm en tissu Sunbrella imperméable et déhoussable.</p>`,
      ...
      images: [
        {
          url: "https://images.unsplash.com/photo-1520209759809-a9bcb6cb3241?w=800",
          isPrimary: true,
        },
      ],
      attributes: [
...
<p>Ce grand seau en inox double paroi de 15L garde vos boissons fraîches pendant des heures. Sur son pied en bambou, il trône élégamment au milieu de votre terrasse lors de vos apéros estivaux.</p>`,
    ...
    {
      name: "Pergola bioclimatique autoportée 4×3 m — Aluminium Graphite (Hespéride AVILA)",
      slug: "Pergola-bioclimatique-autoportée-4×3-m",
      sku: "PER-BIO-AUT",
      shortDescription: "Pergola bioclimatique Hespéride AVILA, autoportée 4 poteaux 4 x 3 m. Lames orientables aluminium graphite, signature Hespéride.",
      description: `<h3>Pergola bioclimatique </h3>
<p>La pergola bioclimatique autoportée AVILA 4×3 m Graphite crée un espace ombragé sur n’importe quelle partie de votre jardin, sans nécessiter de mur d’appui. Posée sur ses 4 poteaux, elle offre une liberté d’implantation totale.

Ses lames orientables vous permettent de gérer l’ombre, la ventilation et la protection contre la pluie d’un simple geste.

</p>`,
      price: 499.99,
      compareAtPrice: 1248.99,
      stock: 20,
      categoryId: catDecoration.id,
      brandId: brandJardinia.id,
      images: [
  {
    url: "https://i.ibb.co/W4zK5tbL/KIT-000573-main-image-web-810faa601fa3497eb7396d1b49b47e00-xlarge.jpg",
    isPrimary: true,
  },
  {
    url: "https://i.ibb.co/MkxDWRpQ/KIT-000573-d6826106f5c04ebb85fbacd095548348-xlarge.jpg",
    isPrimary: false,
  },
  {
    url: "https://i.ibb.co/DPHhC0G9/KIT-000573-3ac14d10d5ab46d9b008dcb227b0bb65-xlarge.jpg",
    isPrimary: false,
  },
],
      attributes: [
