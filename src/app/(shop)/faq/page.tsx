...
const FAQ_DATA = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Puis-je modifier ou annuler ma commande ?", a: "Une commande peut être modifiée ou annulée dans les 2 heures suivant sa validation, avant expédition. Contactez-nous rapidement par e-mail ou via le formulaire de contact." },
  ...
  },
  {
    ...
    questions: [
      { q: "Quelle est votre politique de retour ?", a: "Vous disposez de 30 jours à compter de la réception pour retourner un article, dans son emballage d'origine et en parfait état. Les frais de retour sont à votre charge sauf en cas d'erreur de notre part." },
      { q: "Comment initier un retour ?", a: "Connectez-vous à votre espace client, accédez à « Mes commandes », sélectionnez l'article concerné et cliquez sur « Retourner cet article ». Suivez ensuite les instructions pour générer votre bon de retour." },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Un produit peut-il être en rupture de stock ?", a: "Oui, certains articles très demandés peuvent être temporairement indisponibles. Vous pouvez nous contacter pour être informé du réapprovisionnement." },
      { q: "Les photos sont-elles contractuelles ?", a: "Oui, les photos des produits représentent fidèlement les articles vendus. En cas de doute sur un produit, n'hésitez pas à nous contacter avant l'achat." },
    ],
  },
  {
    category: "Compte client",
    questions: [
      { q: "Comment créer un compte ?", a: "Cliquez sur « Connexion » puis « Créer un compte ». Remplissez le formulaire avec vos informations. La création est gratuite et vous permet de suivre vos commandes, gérer vos favoris et accélérer vos prochains achats." },
      ...
      { q: "Comment supprimer mon compte ?", a: "Pour supprimer votre compte, contactez-nous par e-mail à contact@jardinia-france.fr en précisant votre adresse e-mail de connexion. La suppression est définitive et sera effectuée sous 30 jours." },
    ],
  },
];
                ...
                {cat.questions.map((item) => (
                  ...
                  >
                    <summary className="flex items-center justify-between p-4 cursor-pointer hover:bg-gray-50 transition-colors list-none select-none">
                      ...
                      {/* Chevron animé CSS */}
                      <span className="flex-shrink-0 w-5 h-5 text-gray-400 group-open:text-primary-600 transition-colors">
                        <svg viewBox="0 0 20 20" fill="currentColor" className="transition-transform duration-200 group-open:rotate-180">
                          <path fillRule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clipRule="evenodd" />
                        </svg>
                      </span>
                    </summary>
                    <div className="px-4 pb-4 pt-3 text-gray-600 text-sm leading-relaxed border-t border-gray-100">
                      {item.a}
                    </div>
                  </details>
                ))}
