    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-anthracite-800">Connexion</h1>
        ...
        <div className="card p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-1">
                ...
                <Link href="/auth/mot-de-passe-oublie" className="text-xs text-primary-600 hover:underline">
                  Mot de passe oublié ?
                </Link>
              </div>
          ...
          {/* Bouton Google — à réactiver quand GOOGLE_CLIENT_ID est configuré
          ...
          <button onClick={() => signIn("google", { callbackUrl })} className="btn-outline w-full flex items-center justify-center gap-2 py-2.5">
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href={`/auth/inscription${callbackUrl !== "/compte" ? `?callbackUrl=${callbackUrl}` : ""}`} className="text-primary-600 font-medium hover:underline">
            Créer un compte
          </Link>
        </p>
      </div>
