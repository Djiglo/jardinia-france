...
const slides = [
  {
    id: 1,
    title: "L'été est là — Profitez-en !",
    subtitle: "Piscines & accessoires",
    description:
      "Jusqu'à -20% sur toute notre sélection de piscines hors-sol. Des modèles pour toutes les tailles de jardin.",
  ...
  {
    id: 2,
    title: "Profitez de votre terrasse",
    ...
    image: "https://i.ibb.co/WWmyQmvP/upscalemedia-transformed.jpg",
  ...
  {
    id: 3,
    title: "Soirées barbecue en famille",
